...
class AbilitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ability" do
    assert_difference('Ability.count') do
      post abilities_url, params: { ability: { description: @ability.description, hero_id: @ability.hero_id, is_ultimate: @ability.is_ultimate, name: @ability.name } }
    end
  ...
  test "should update ability" do
    patch ability_url(@ability), params: { ability: { description: @ability.description, hero_id: @ability.hero_id, is_ultimate: @ability.is_ultimate, name: @ability.name } }
